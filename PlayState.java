...
import Entity.LittleShip;
import Entity.Tesseract;
import Entity.Enemy;
...
public class PlayState extends GameState {
	...
	public void populateEnemies() {
		...
		LittleShip b = new LittleShip(-36 - rand.nextInt(300), yBird);

		Tesseract d = new Tesseract(-36 - rand.nextInt(300), 100 + rand.nextInt(325));
		enemies.add(b);
		addCount++;
